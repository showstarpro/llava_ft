...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="/lpai/volumes/so-volume-ga/models/vicuna-7b-v1.5")
    version: Optional[str] = field(default="v0")
    freeze_backbone: bool = field(default=False)
    tune_mm_mlp_adapter: bool = field(default=False)
    vision_tower: Optional[str] = field(default='/lpai/volumes/so-volume-ga/models/clip-vit-large-patch14-336')
...
@dataclass
class DataArguments:
    data_path: str = field(default='/lpai/dataset/mllm-dataset/24-09-28-1/LLaVA-Pretrain/blip_laion_cc_sbu_558k.json',
                           metadata={"help": "Path to the training data."})
    lazy_preprocess: bool = False
    is_multimodal: bool = False
    image_folder: Optional[str] = field(default='/lpai/dataset/mllm-dataset/24-09-28-1/LLaVA-Pretrain/images')
