...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/lpai/volumes/so-volume-ga/lhp/llava-v1.5/vicuna-7b-v1.5-pretrain/llava-v1.5-7b-clip-vitl-336-control-v14")
    ...
    parser.add_argument("--answers-file", type=str, default="/lpai/LLaVA/playground/data/eval/scienceqa/test.jsonl")
